...
type Subscription struct {
	...
	RSSLatestEpisode   int        `json:"rss_latest_episode" gorm:"default:0"` // RSS 实际发现的最新集数
...
func (s Subscription) RelativeRSSLatestEpisode() int {
	return s.RelativeEpisode(s.RSSLatestEpisode)
}
